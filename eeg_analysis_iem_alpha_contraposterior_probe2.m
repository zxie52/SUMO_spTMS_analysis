...
if strcmp(condition, 'testorient')
    fpath13 = 'E:\SUMO_further_data_pack_zx\N2pc_IEM\new_results\IEM_results_alpha_probe2_testorient';
end

if strcmp(condition, 'targetorient')
    fpath13 = 'E:\SUMO_further_data_pack_zx\N2pc_IEM\new_results\IEM_results_alpha_probe2_targetorient';
end
...
for k =  1 : 2
    ...
    if k == 1
        ...
        if strcmp(condition, 'testorient')
            title('Reconstruction from Alpha Power in ContraPosterior Channels Left probe(probe2)(testorient)', 'Fontsize', titleFontSize)
        elseif strcmp(condition, 'targetorient')
            title('Reconstruction from Alpha Power in ContraPosterior Channels Left probe(probe2)(targetorient)', 'Fontsize', titleFontSize)
        end            
    ...
    elseif k == 2 
        ylabel(h, 'Channel Response (µV^2)','Fontsize', axisFontSize)
        if strcmp(condition, 'testorient')
            title('Reconstruction from Alpha Power in ContraPosterior Channels Right probe(probe2)(testorient)', 'Fontsize', titleFontSize)
        elseif strcmp(condition, 'targetorient')
            title('Reconstruction from Alpha Power in ContraPosterior Channels Right probe(probe2)(targetorient)', 'Fontsize', titleFontSize)
        end   
        xlabel('Time from probe onset(msec)','Fontsize', axisFontSize)
        ylabel('Centered Orientation Channel (°)','Fontsize', axisFontSize)
