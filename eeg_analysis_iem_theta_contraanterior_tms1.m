...
for l = 1:length(subject)
    ...
    for t = 3 % This time we only preprocess the TMS 1 data
        ...
        % Average the 3 frequencies into one
        ...
        for i = 1 : length(group_name) % notice that we used the parallel envi in permutation
            ...
            if ismember(i, [1 2])
                ...
                save(strcat('IEM_Exp1_contraanterior', 'SUMO_', subject{l}, '_epoch1_', group_name{i}), 'dstimes', 'stimlabels', 'chanrespsL', 'chanresp_permsL', 'h'); 
                ...
                saveas(gcf, strcat('SUMO_', subject{l}, '_iem_', group_name{i}));
                saveas(gcf, strcat('SUMO_', subject{l}, '_iem_', group_name{i}, '.png'));   
                save(strcat('IEM_Exp1_contraanterior', 'SUMO_', subject{l}, '_epoch1_', group_name{i}), 'dstimes', 'stimlabels', 'chanrespsR', 'chanresp_permsR', 'h'); 
            end
        end
    end
end
...
for i = 1 : length(subject)
    for j = 1:2
        load(strcat('IEM_Exp1_contraanterior', 'SUMO_', subject{i}, '_epoch1_', group_name{j}, '.mat'));
    end
...
save(strcat('IEM_Exp1_contraanterior_allsubjects_epoch1_ami.mat'), 'dstimes', 'stimlabels', 'chanrespsL_allsub', 'chanresp_permsL_allsub', 'chanrespsR_allsub', 'chanresp_permsR_allsub'); 
...
title('IEM Left Stimulus Reconstruction from ContraAnterior Electrodes(TMS1 AMI)(Theta)')
xlabel('Centered Orientation Channel (°)')
ylabel('Channel Response (µV^2)')
legend({'error', '-200-0ms','error','30-300ms','error','300-600ms','error','600-800ms'})

title('IEM Left Stimulus Reconstruction ContraAnterior Electrodes(TMS1 AMI)(Theta)')
xlabel('Centered Orientation Channel (°)')
ylabel('Channel Response (µV^2)')

saveas(gcf, 'allsubjects_iem_left_AMI_theta.png');
%% Plotting Right
...
title('IEM Right Stimulus Reconstruction from ContraAnterior Electrodes(TMS1 AMI)(Theta)')
xlabel('Centered Orientation Channel (°)')
ylabel('Channel Response (µV^2)')
legend({'error', '-200-0ms','error','30-300ms','error','300-600ms','error','600-800ms'})

title('IEM Right Stimulus Reconstruction ContraAnterior Electrodes(TMS1 AMI)(Theta)')
xlabel('Centered Orientation Channel (°)')
ylabel('Channel Response (µV^2)')

saveas(gcf, 'allsubjects_iem_right_AMI_theta.png');
...
for k =  1 : 2
    ...
    if k == 1
        ...
        title('Reconstruction from Theta Power in ContraAnterior Channels Left AMI(TMS1)', 'Fontsize', titleFontSize)
    ...
    elseif k == 2 
        ylabel(h, 'Channel Response (µV^2)','Fontsize', axisFontSize)
        title('Reconstruction from Theta Power in ContraAnterior Channels Right AMI(TMS1)', 'Fontsize', titleFontSize)
        xlabel('Time from TMS onset(msec)','Fontsize', axisFontSize)
        ylabel('Centered Orientation Channel (°)','Fontsize', axisFontSize)
...
save(strcat('IEM_Exp1_contraanterior_allsubjects_epoch1_umi_iem.mat'), 'dstimes', 'stimlabels', 'chanrespsL_allsub', 'chanresp_permsL_allsub', 'chanrespsR_allsub', 'chanresp_permsR_allsub'); 
...
title('IEM Left Stimulus Reconstruction from ContraAnterior Electrodes(TMS1 UMI)(Theta)')
xlabel('Centered Orientation Channel (°)')
ylabel('Channel Response')
legend({'error', '-200-0ms','error','30-300ms','error','300-600ms','error','600-800ms'})

title('IEM Left Stimulus Reconstruction ContraAnterior Electrodes(TMS1 UMI)(Theta)')
xlabel('Centered Orientation Channel (°)')
ylabel('Channel Response')

saveas(gcf, 'allsubjects_iem_left_UMI_theta.png');
%% Plotting Right
...
title('IEM Right Stimulus Reconstruction from ContraAnterior Electrodes(TMS1 UMI)(Theta)')
xlabel('Centered Orientation Channel (°)')
ylabel('Channel Response')
legend({'error', '-200-0ms','error','30-300ms','error','300-600ms','error','600-800ms'})

title('IEM Right Stimulus Reconstruction ContraAnterior Electrodes(TMS1 UMI)(Theta)')
xlabel('Centered Orientation Channel (°)')
ylabel('Channel Response')

saveas(gcf, 'allsubjects_iem_right_UMI_theta.png');
...
for k =  1 : 2
    ...
    if k == 1
        ylabel(h, 'Channel Response (µV^2)','Fontsize', axisFontSize)
        title('Reconstruction from Theta Power in ContraAnterior Channels Left UMI(TMS1)', 'Fontsize', titleFontSize)
        xlabel('Time from TMS onset(msec)','Fontsize', axisFontSize)
        ylabel('Centered Orientation Channel (°)','Fontsize', axisFontSize)
    ...
    elseif k == 2 
        ylabel(h, 'Channel Response (µV^2)','Fontsize', axisFontSize)
        title('Reconstruction from Theta Power in ContraAnterior Channels Right UMI(TMS1)', 'Fontsize', titleFontSize)
        xlabel('Time from TMS onset(msec)','Fontsize', axisFontSize)
        ylabel('Centered Orientation Channel (°)','Fontsize', axisFontSize)
