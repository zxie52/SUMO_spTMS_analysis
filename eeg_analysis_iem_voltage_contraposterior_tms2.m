...
fpath13 = '/afs/crc.nd.edu/group/roselab/vol2/zx/new_results/IEM_results_voltage_tms2';
...
%% Plotting Left 
    ...
    if ismember(i, group_left) % for left stimuli
        ...
        title(strcat("Reconstruction from Voltage in Contra-Posterior Electrodes (TMS2 ", group_name{i}, ")"));
        xlabel("Centered Orientation Channel");
        ylabel("Channel Response");
        legend({'error', '-200-0ms','error','20-300ms','error','300-600ms','error','600-800ms'})
        ...
        title(strcat("Reconstruction from Voltage in Contra-Posterior Electrodes (TMS2 ", group_name{i}, ")"), 'Fontsize', titleFontSize)
