...
fpath13 = '/afs/crc.nd.edu/group/roselab/vol2/zx/new_results/IEM_results_voltage_tms1';
...
for l = 1:length(subject)
    ...
    for t = 3 % This time we only preprocess the TMS 1 data
        ...
        for i = 1 : length(group_name) % notice that we used the parallel envi in permutation
            ...
            chanresp_permsL = [];
            chanresp_permsR = [];
            %Supertrials for four different stimuli (AMI + UMI)
            ...
            if ismember(i, [1 2])
                ...
                % for subjects who do not have the 3rd channel trials, we copy the 5th channel to the 3rd
                if h(1,1,3) == 0 
                ...
                tw = dsearchn(dstimes',[-100 -20]'); %baseline, k = gray
                ...
                legend({'error', '-100-0ms','error','30-300ms','error','300-600ms','error','600-800ms'})
...
save(strcat('IEM_Exp1_contraposterior_allsubjects_epoch1_tms1_ami_iem.mat'), 'dstimes', 'stimlabels', 'chanrespsL_allsub', 'chanresp_permsL_allsub', 'chanrespsR_allsub', 'chanresp_permsR_allsub'); 
...
title('IEM Left Stimulus Reconstruction from Contraposterior Electrodes(TMS1 AMI)')
xlabel('Centered Orientation Channel (°)')
ylabel('Channel Response (µV^2)')
legend({'error', '-100-0ms','error','30-300ms','error','300-600ms','error','600-800ms'})

title('IEM Left Stimulus Reconstruction Contraposterior Electrodes(TMS1 AMI)')
xlabel('Centered Orientation Channel (°)')
ylabel('Channel Response (µV^2)')

saveas(gcf, 'allsubjects_iem_left_AMI.png');
%% Plotting Right
...
title('IEM Right Stimulus Reconstruction from Contraposterior Electrodes(TMS1 AMI)')
xlabel('Centered Orientation Channel (°)')
ylabel('Channel Response (µV^2)')
legend({'error', '-100-0ms','error','30-300ms','error','300-600ms','error','600-800ms'})

title('IEM Right Stimulus Reconstruction Contraposterior Electrodes(TMS1 AMI)')
xlabel('Centered Orientation Channel (°)')
ylabel('Channel Response (µV^2)')

saveas(gcf, 'allsubjects_iem_right_AMI.png');
...
for k =  1 : 2
    ...
    if k == 1
        ...
        title('Reconstruction from Voltage in ContraPosterior Channels Left AMI(TMS1)', 'Fontsize', titleFontSize)
    ...
    elseif k == 2 
        ylabel(h, 'Channel Response (µV^2)','Fontsize', axisFontSize)
        title('Reconstruction from Voltage in ContraPosterior Channels Right AMI(TMS1)', 'Fontsize', titleFontSize)
        xlabel('Time from TMS onset(msec)','Fontsize', axisFontSize)
        ylabel('Centered Orientation Channel (°)','Fontsize', axisFontSize)
...
save(strcat('IEM_Exp1_contraposterior_allsubjects_epoch1_tms1_umi_iem.mat'), 'dstimes', 'stimlabels', 'chanrespsL_allsub', 'chanresp_permsL_allsub', 'chanrespsR_allsub', 'chanresp_permsR_allsub'); 
...
title('IEM Left Stimulus Reconstruction from Contraposterior Electrodes(TMS1 UMI)')
xlabel('Centered Orientation Channel (°)')
ylabel('Channel Response')
legend({'error', '-100-0ms','error','30-300ms','error','300-600ms','error','600-800ms'})

title('IEM Left Stimulus Reconstruction Contraposterior Electrodes(TMS1 UMI)')
xlabel('Centered Orientation Channel (°)')
ylabel('Channel Response')

saveas(gcf, 'allsubjects_iem_left_UMI.png');
%% Plotting Right
...
title('IEM Right Stimulus Reconstruction from Contraposterior Electrodes(TMS1 UMI)')
xlabel('Centered Orientation Channel (°)')
ylabel('Channel Response')
legend({'error', '-100-0ms','error','30-300ms','error','300-600ms','error','600-800ms'})

title('IEM Right Stimulus Reconstruction Contraposterior Electrodes(TMS1 UMI)')
xlabel('Centered Orientation Channel (°)')
ylabel('Channel Response')

saveas(gcf, 'allsubjects_iem_right_UMI.png');
...
for k =  1 : 2
    ...
    if k == 1
        ylabel(h, 'Channel Response (µV^2)','Fontsize', axisFontSize)
        title('Reconstruction from Voltage in ContraPosterior Channels Left UMI(TMS1)', 'Fontsize', titleFontSize)
        xlabel('Time from TMS onset(msec)','Fontsize', axisFontSize)
        ylabel('Centered Orientation Channel (°)','Fontsize', axisFontSize)
    ...
    elseif k == 2 
        ylabel(h, 'Channel Response (µV^2)','Fontsize', axisFontSize)
        title('Reconstruction from Voltage in ContraPosterior Channels Right UMI(TMS1)', 'Fontsize', titleFontSize)
        xlabel('Time from TMS onset(msec)','Fontsize', axisFontSize)
        ylabel('Centered Orientation Channel (°)','Fontsize', axisFontSize)
