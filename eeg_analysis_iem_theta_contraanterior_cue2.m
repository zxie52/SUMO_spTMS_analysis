...
for l = 1:length(subject)
    ...
    for t = 5 % This time we only preprocess the Probe1 data
        ...
        for i = 1 : length(group_name) % notice that we used the parallel envi in permutation
            ...
            if ismember(i, [1 2])
                ...
                save(strcat('IEM_Exp1_contraanterior', 'SUMO_', subject{l}, '_epoch1_', group_name{i}), 'dstimes', 'stimlabels', 'chanrespsL', 'chanresp_permsL'); 
                ...
                cd(fpath13);
                saveas(gcf, strcat('SUMO_', subject{l}, '_iem_', group_name{i}, '.png'));    
                save(strcat('IEM_Exp1_contraanterior', 'SUMO_', subject{l}, '_epoch1_', group_name{i}), 'dstimes', 'stimlabels', 'chanrespsR', 'chanresp_permsR'); 
            end
        end
    end
end
...
save(strcat('IEM_Exp1_contraanterior_allsubjects_epoch1_cue_ami_iem.mat'), 'dstimes', 'stimlabels', 'chanrespsL_allsub', 'chanresp_permsL_allsub', 'chanrespsR_allsub', 'chanresp_permsR_allsub'); 
...
title('IEM Left Stimulus Reconstruction from ContraAnterior Electrodes(cue2 AMI)')
xlabel('Centered Orientation Channel (°)')
ylabel('Channel Response (µV^2)')
legend({'error', '-80-0ms','error','20-200ms','error','200-400ms'})

title('IEM Left Stimulus Reconstruction ContraAnterior Electrodes(cue2 AMI)')
xlabel('Centered Orientation Channel (°)')
ylabel('Channel Response (µV^2)')
...
title('IEM Right Stimulus Reconstruction from ContraAnterior Electrodes(cue2 AMI)')
xlabel('Centered Orientation Channel (°)')
ylabel('Channel Response (µV^2)')
legend({'error', '-80-0ms','error','20-200ms','error','200-400ms'})

title('IEM Right Stimulus Reconstruction ContraAnterior Electrodes(cue2 AMI)')
xlabel('Centered Orientation Channel (°)')
ylabel('Channel Response (µV^2)')
...
for k =  1 : 2
    ...
    if k == 1
        ...
        title('Reconstruction from Theta-power in ContraAnterior Channels Left cue(Cue2)(AMI)', 'Fontsize', titleFontSize)
    ...
    elseif k == 2 
        ylabel(h, 'Channel Response (µV^2)','Fontsize', axisFontSize)
        title('Reconstruction from Theta-power in ContraAnterior Channels Right cue(Cue2)(AMI)', 'Fontsize', titleFontSize)
        xlabel('Time from cue onset(msec)','Fontsize', axisFontSize)
        ylabel('Centered Orientation Channel (°)','Fontsize', axisFontSize)
...
save(strcat('IEM_Exp1_contraanterior_allsubjects_epoch1_cue_umi_iem.mat'), 'dstimes', 'stimlabels', 'chanrespsL_allsub', 'chanresp_permsL_allsub', 'chanrespsR_allsub', 'chanresp_permsR_allsub'); 
...
title('IEM Left Stimulus Reconstruction from ContraAnterior Electrodes(Cue2 UMI)')
xlabel('Centered Orientation Channel (°)')
ylabel('Channel Response (µV^2)')
legend({'error', '-100-0ms','error','20-200ms','error','200-400ms'})

title('IEM Left Stimulus Reconstruction ContraAnterior Electrodes(Cue2 UMI)')
xlabel('Centered Orientation Channel (°)')
ylabel('Channel Response (µV^2)')
...
title('IEM Right Stimulus Reconstruction from ContraAnterior Electrodes(Cue2 UMI)')
xlabel('Centered Orientation Channel (°)')
ylabel('Channel Response (µV^2)')
legend({'error', '-100-0ms','error','20-200ms','error','200-400ms'})

title('IEM Right Stimulus Reconstruction ContraAnterior Electrodes(Cue2 UMI)')
xlabel('Centered Orientation Channel (°)')
ylabel('Channel Response (µV^2)')
...
for k =  1 : 2
    ...
    if k == 1
        ylabel(h, 'Channel Response (µV^2)','Fontsize', axisFontSize)
        title('Reconstruction from Theta-power in ContraAnterior Channels Left cue(Cue2)(UMI)', 'Fontsize', titleFontSize)
        xlabel('Time from cue onset(msec)','Fontsize', axisFontSize)
        ylabel('Centered Orientation Channel (°)','Fontsize', axisFontSize)
    ...
    elseif k == 2 
        ylabel(h, 'Channel Response (µV^2)','Fontsize', axisFontSize)
        title('Reconstruction from Theta-power in ContraAnterior Channels Right cue(Cue2)(UMI)', 'Fontsize', titleFontSize)
        xlabel('Time from cue onset(msec)','Fontsize', axisFontSize)
        ylabel('Centered Orientation Channel (°)','Fontsize', axisFontSize)
