...
% plot the left UMI
p2 = plot(EEG.times, distance_cos_group_ave_smoothed(2,:), 'lineWidth', 3, 'Color', 'g');
shadedError(EEG.times, distance_cos_group_ave_smoothed(2,:), distance_cos_group_err_smoothed(2,:), 'g');
% plot the right AMI
p3 = plot(EEG.times, distance_cos_group_ave_smoothed(3,:), 'lineWidth', 3, 'Color', 'b');
shadedError(EEG.times, distance_cos_group_ave_smoothed(3,:), distance_cos_group_err_smoothed(3,:), 'b');
% plot the right UMI
p4 = plot(EEG.times, distance_cos_group_ave_smoothed(4,:), 'lineWidth', 3, 'Color', 'y');
shadedError(EEG.times, distance_cos_group_ave_smoothed(4,:), distance_cos_group_err_smoothed(4,:), 'y');
% add the legend
