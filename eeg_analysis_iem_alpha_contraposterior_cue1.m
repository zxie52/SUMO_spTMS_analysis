...
fpath13 = '/afs/crc.nd.edu/group/roselab/vol2/zx/new_results/IEM_results_alpha_cue1';
...
save(strcat('IEM_Exp1_contraposterior_allsubjects_epoch1_cue_ami_iem.mat'), 'dstimes', 'stimlabels', 'chanrespsL_allsub', 'chanresp_permsL_allsub', 'chanrespsR_allsub', 'chanresp_permsR_allsub'); 
...
for k =  1 : 2
    ...
    if k == 1
        ...
        title('Reconstruction from Alpha-power in ContraPosterior Channels Left cue(Cue1)(AMI)', 'Fontsize', titleFontSize)
    ...
    elseif k == 2 
        ylabel(h, 'Channel Response (µV^2)','Fontsize', axisFontSize)
        title('Reconstruction from Alpha-power in ContraPosterior Channels Right cue(Cue1)(AMI)', 'Fontsize', titleFontSize)
        xlabel('Time from cue onset(msec)','Fontsize', axisFontSize)
        ylabel('Centered Orientation Channel (°)','Fontsize', axisFontSize)
...
save(strcat('IEM_Exp1_contraposterior_allsubjects_epoch1_cue_umi_iem.mat'), 'dstimes', 'stimlabels', 'chanrespsL_allsub', 'chanresp_permsL_allsub', 'chanrespsR_allsub', 'chanresp_permsR_allsub'); 
...
title('IEM Right Stimulus Reconstruction Contraposterior Electrodes(Cue1 UMI)')
xlabel('Centered Orientation Channel (°)')
ylabel('Channel Response (µV^2)')
...
for k =  1 : 2
    ...
    if k == 1
        ylabel(h, 'Channel Response (µV^2)','Fontsize', axisFontSize)
        title('Reconstruction from Alpha-power in ContraPosterior Channels Left cue(Cue1)(UMI)', 'Fontsize', titleFontSize)
        xlabel('Time from cue onset(msec)','Fontsize', axisFontSize)
        ylabel('Centered Orientation Channel (°)','Fontsize', axisFontSize)
    ...
    elseif k == 2 
        ylabel(h, 'Channel Response (µV^2)','Fontsize', axisFontSize)
        title('Reconstruction from Alpha-power in ContraPosterior Channels Right cue(Cue1)(UMI)', 'Fontsize', titleFontSize)
        xlabel('Time from cue onset(msec)','Fontsize', axisFontSize)
        ylabel('Centered Orientation Channel (°)','Fontsize', axisFontSize)
