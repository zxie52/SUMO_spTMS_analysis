...
fpath13 = '/afs/crc.nd.edu/group/roselab/vol2/zx/new_results/IEM_results_broadband_tms1';
...
title('IEM Left Stimulus Reconstruction from Contraposterior Electrodes(TMS1 AMI)(Broad)')
xlabel('Centered Orientation Channel (°)')
ylabel('Channel Response (µV^2)')
legend({'error', '-200-0ms','error','30-300ms','error','300-600ms','error','600-800ms'})

title('IEM Left Stimulus Reconstruction Contraposterior Electrodes(TMS1 AMI)(Broad)')
xlabel('Centered Orientation Channel (°)')
ylabel('Channel Response (µV^2)')

saveas(gcf, 'allsubjects_iem_left_AMI_broad.png');
%% Plotting Right
...
title('IEM Right Stimulus Reconstruction from Contraposterior Electrodes(TMS1 AMI)(Broad)')
xlabel('Centered Orientation Channel (°)')
ylabel('Channel Response (µV^2)')
legend({'error', '-200-0ms','error','30-300ms','error','300-600ms','error','600-800ms'})

title('IEM Right Stimulus Reconstruction Contraposterior Electrodes(TMS1 AMI)(Broad)')
xlabel('Centered Orientation Channel (°)')
ylabel('Channel Response (µV^2)')

saveas(gcf, 'allsubjects_iem_right_AMI_broad.png');
...
for k =  1 : 2
    ...
    if k == 1
        ...
        title('Reconstruction from Broadband Power in ContraPosterior Channels Left AMI(TMS1)', 'Fontsize', titleFontSize)
    ...
    elseif k == 2 
        ylabel(h, 'Channel Response (µV^2)','Fontsize', axisFontSize)
        title('Reconstruction from Broadband Power in ContraPosterior Channels Right AMI(TMS1)', 'Fontsize', titleFontSize)
        xlabel('Time from TMS onset(msec)','Fontsize', axisFontSize)
        ylabel('Centered Orientation Channel (°)','Fontsize', axisFontSize)
...
title('IEM Left Stimulus Reconstruction from Contraposterior Electrodes(TMS1 UMI)(Broad)')
xlabel('Centered Orientation Channel (°)')
ylabel('Channel Response')
legend({'error', '-200-0ms','error','30-300ms','error','300-600ms','error','600-800ms'})

title('IEM Left Stimulus Reconstruction Contraposterior Electrodes(TMS1 UMI)(Broad)')
xlabel('Centered Orientation Channel (°)')
ylabel('Channel Response')

saveas(gcf, 'allsubjects_iem_left_UMI_broad.png');
%% Plotting Right
...
title('IEM Right Stimulus Reconstruction from Contraposterior Electrodes(TMS1 UMI)(Broad)')
xlabel('Centered Orientation Channel (°)')
ylabel('Channel Response')
legend({'error', '-200-0ms','error','30-300ms','error','300-600ms','error','600-800ms'})

title('IEM Right Stimulus Reconstruction Contraposterior Electrodes(TMS1 UMI)(Broad)')
xlabel('Centered Orientation Channel (°)')
ylabel('Channel Response')

saveas(gcf, 'allsubjects_iem_right_UMI_broad.png');
...
for k =  1 : 2
    ...
    if k == 1
        ylabel(h, 'Channel Response (µV^2)','Fontsize', axisFontSize)
        title('Reconstruction from Broadband Power in ContraPosterior Channels Left UMI(TMS1)', 'Fontsize', titleFontSize)
        xlabel('Time from TMS onset(msec)','Fontsize', axisFontSize)
        ylabel('Centered Orientation Channel (°)','Fontsize', axisFontSize)
    ...
    elseif k == 2 
        ylabel(h, 'Channel Response (µV^2)','Fontsize', axisFontSize)
        title('Reconstruction from Broadband Power in ContraPosterior Channels Right UMI(TMS1)', 'Fontsize', titleFontSize)
        xlabel('Time from TMS onset(msec)','Fontsize', axisFontSize)
        ylabel('Centered Orientation Channel (°)','Fontsize', axisFontSize)
