...
title('IEM Left Stimulus Reconstruction from ContraAnterior Electrodes(cue1 AMI)')
xlabel('Centered Orientation Channel (°)')
ylabel('Channel Response (µV^2)')
legend({'error', '-80-0ms','error','20-200ms','error','200-400ms'})

title('IEM Left Stimulus Reconstruction ContraAnterior Electrodes(cue1 AMI)')
xlabel('Centered Orientation Channel (°)')
ylabel('Channel Response (µV^2)')
...
title('IEM Right Stimulus Reconstruction from ContraAnterior Electrodes(cue1 AMI)')
xlabel('Centered Orientation Channel (°)')
ylabel('Channel Response (µV^2)')
legend({'error', '-80-0ms','error','20-200ms','error','200-400ms'})

title('IEM Right Stimulus Reconstruction ContraAnterior Electrodes(cue1 AMI)')
xlabel('Centered Orientation Channel (°)')
ylabel('Channel Response (µV^2)')
...
for k =  1 : 2
    ...
    if k == 1
        ...
        title('Reconstruction from Theta-power in ContraAnterior Channels Left cue(Cue1)(AMI)', 'Fontsize', titleFontSize)
    ...
    elseif k == 2 
        ylabel(h, 'Channel Response (µV^2)','Fontsize', axisFontSize)
        title('Reconstruction from Theta-power in ContraAnterior Channels Right cue(Cue1)(AMI)', 'Fontsize', titleFontSize)
        xlabel('Time from cue onset(msec)','Fontsize', axisFontSize)
        ylabel('Centered Orientation Channel (°)','Fontsize', axisFontSize)
...
title('IEM Left Stimulus Reconstruction from ContraAnterior Electrodes(Cue1 UMI)')
xlabel('Centered Orientation Channel (°)')
ylabel('Channel Response (µV^2)')
legend({'error', '-100-0ms','error','20-200ms','error','200-400ms'})

title('IEM Left Stimulus Reconstruction ContraAnterior Electrodes(Cue1 UMI)')
xlabel('Centered Orientation Channel (°)')
ylabel('Channel Response (µV^2)')
...
title('IEM Right Stimulus Reconstruction from ContraAnterior Electrodes(Cue1 UMI)')
xlabel('Centered Orientation Channel (°)')
ylabel('Channel Response (µV^2)')
legend({'error', '-100-0ms','error','20-200ms','error','200-400ms'})

title('IEM Right Stimulus Reconstruction ContraAnterior Electrodes(Cue1 UMI)')
xlabel('Centered Orientation Channel (°)')
ylabel('Channel Response (µV^2)')
...
for k =  1 : 2
    ...
    if k == 1
        ylabel(h, 'Channel Response (µV^2)','Fontsize', axisFontSize)
        title('Reconstruction from Theta-power in ContraAnterior Channels Left cue(Cue1)(UMI)', 'Fontsize', titleFontSize)
        xlabel('Time from cue onset(msec)','Fontsize', axisFontSize)
        ylabel('Centered Orientation Channel (°)','Fontsize', axisFontSize)
    ...
    elseif k == 2 
        ylabel(h, 'Channel Response (µV^2)','Fontsize', axisFontSize)
        title('Reconstruction from Theta-power in ContraAnterior Channels Right cue(Cue1)(UMI)', 'Fontsize', titleFontSize)
        xlabel('Time from cue onset(msec)','Fontsize', axisFontSize)
        ylabel('Centered Orientation Channel (°)','Fontsize', axisFontSize)
