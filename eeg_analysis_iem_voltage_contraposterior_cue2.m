...
fpath13 = '/afs/crc.nd.edu/group/roselab/vol2/zx/new_results/IEM_results_voltage_cue2';
...
for l = 1:length(subject)
    ...
    for t = 5 % This time we only preprocess the Cue1 data
...
save(strcat('IEM_Exp1_contraposterior_allsubjects_epoch1_cue2_ami_iem.mat'), 'dstimes', 'stimlabels', 'chanrespsL_allsub', 'chanresp_permsL_allsub', 'chanrespsR_allsub', 'chanresp_permsR_allsub'); 
...
title('IEM Left Stimulus Reconstruction from Contraposterior Electrodes(Cue2 AMI)')
xlabel('Centered Orientation Channel (°)')
ylabel('Channel Response (µV^2)')
legend({'error', '-100-0ms','error','20-200ms','error','200-400ms'})

title('IEM Left Stimulus Reconstruction Contraposterior Electrodes(Cue2 AMI)')
xlabel('Centered Orientation Channel (°)')
ylabel('Channel Response (µV^2)')
...
title('IEM Right Stimulus Reconstruction from Contraposterior Electrodes(Cue2 AMI)')
xlabel('Centered Orientation Channel (°)')
ylabel('Channel Response (µV^2)')
legend({'error', '-100-0ms','error','20-200ms','error','200-400ms'})

title('IEM Right Stimulus Reconstruction Contraposterior Electrodes(Cue2 AMI)')
xlabel('Centered Orientation Channel (°)')
ylabel('Channel Response (µV^2)')
...
for k =  1 : 2
    ...
    if k == 1
        ...
        title('Reconstruction from Voltage in ContraPosterior Channels Left cue(Cue2)(AMI)', 'Fontsize', titleFontSize)
    ...
    elseif k == 2 
        ylabel(h, 'Channel Response (µV^2)','Fontsize', axisFontSize)
        title('Reconstruction from Voltage in ContraPosterior Channels Right cue(Cue2)(AMI)', 'Fontsize', titleFontSize)
        xlabel('Time from cue onset(msec)','Fontsize', axisFontSize)
        ylabel('Centered Orientation Channel (°)','Fontsize', axisFontSize)
...
save(strcat('IEM_Exp1_contraposterior_allsubjects_epoch1_cue2_umi_iem.mat'), 'dstimes', 'stimlabels', 'chanrespsL_allsub', 'chanresp_permsL_allsub', 'chanrespsR_allsub', 'chanresp_permsR_allsub'); 
...
title('IEM Left Stimulus Reconstruction from Contraposterior Electrodes(Cue2 UMI)')
xlabel('Centered Orientation Channel (°)')
ylabel('Channel Response (µV^2)')
legend({'error', '-100-0ms','error','20-200ms','error','200-400ms'})

title('IEM Left Stimulus Reconstruction Contraposterior Electrodes(Cue2 UMI)')
xlabel('Centered Orientation Channel (°)')
ylabel('Channel Response (µV^2)')
...
title('IEM Right Stimulus Reconstruction from Contraposterior Electrodes(Cue2 UMI)')
xlabel('Centered Orientation Channel (°)')
ylabel('Channel Response (µV^2)')
legend({'error', '-100-0ms','error','20-200ms','error','200-400ms'})

title('IEM Right Stimulus Reconstruction Contraposterior Electrodes(Cue2 UMI)')
xlabel('Centered Orientation Channel (°)')
ylabel('Channel Response (µV^2)')
...
for k =  1 : 2
    ...
    if k == 1
        ylabel(h, 'Channel Response (µV^2)','Fontsize', axisFontSize)
        title('Reconstruction from Voltage in ContraPosterior Channels Left cue(Cue2)(UMI)', 'Fontsize', titleFontSize)
        xlabel('Time from cue onset(msec)','Fontsize', axisFontSize)
        ylabel('Centered Orientation Channel (°)','Fontsize', axisFontSize)
    ...
    elseif k == 2 
        ylabel(h, 'Channel Response (µV^2)','Fontsize', axisFontSize)
        title('Reconstruction from Voltage in ContraPosterior Channels Right cue(Cue2)(UMI)', 'Fontsize', titleFontSize)
        xlabel('Time from cue onset(msec)','Fontsize', axisFontSize)
        ylabel('Centered Orientation Channel (°)','Fontsize', axisFontSize)
